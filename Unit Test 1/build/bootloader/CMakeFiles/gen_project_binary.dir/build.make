...
.bin_timestamp: bootloader.elf
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold --progress-dir=/home/nicholas/esp/hello_world/build/bootloader/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Generating binary image from built executable"
	/home/nicholas/.espressif/python_env/rtos3.4_py3.8_env/bin/python /home/nicholas/esp/ESP8266_RTOS_SDK/components/esptool_py/esptool/esptool.py --chip esp8266 elf2image --flash_mode dout --flash_freq 40m --flash_size 1MB -o /home/nicholas/esp/hello_world/build/bootloader/bootloader.bin bootloader.elf
	/usr/bin/cmake -E echo "Generated /home/nicholas/esp/hello_world/build/bootloader/bootloader.bin"
	/usr/bin/cmake -E md5sum /home/nicholas/esp/hello_world/build/bootloader/bootloader.bin > /home/nicholas/esp/hello_world/build/bootloader/.bin_timestamp
